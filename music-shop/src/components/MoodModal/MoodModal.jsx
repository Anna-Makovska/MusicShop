...
export default function MoodModal(){
  ...
  useEffect(() => {
    ...
    window.dispatchEvent(new CustomEvent('mood-modal:opened'))
  }, [])
  ...
  function close(){
    ...
    window.dispatchEvent(new CustomEvent('mood-modal:closed'))
  }
  ...
  return (
    <div ref={overlayRef} className={styles.overlay} aria-modal="true" role="dialog">
